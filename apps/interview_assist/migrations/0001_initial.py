    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interviewer_name', models.CharField(default='面试官', max_length=100, verbose_name='面试官姓名')),
                ...
                ('report_file', models.FileField(blank=True, null=True, upload_to='interview_reports/%Y/%m/%d/', verbose_name='报告文件')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_source', models.CharField(default='hr_custom', max_length=50, verbose_name='问题来源')),
                ('question_category', models.CharField(blank=True, max_length=100, verbose_name='问题类别')),
                ...
                ('related_interest_point', models.TextField(blank=True, null=True, verbose_name='关联兴趣点')),
